...
<template>
  ...
  <div
    ...
    <a href=""
      class="border border-white-700 dark:border-gray-300 rounded-lg py-2 px-4 text-white-400 dark:text-gray-300 text-lg mb-5 transition duration-300 ease-in-out hover:text-gray-500 dark:hover:text-gray-400">
    ...
    <h1
      ...
      <span class="relative whitespace-nowrap text-white-600 dark:text-gray-300">and Wellness</span> <br>
      <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
        ...
        <span class="relative">with {{ title }}</span>
      </span>
    </h1>
    <h2 class="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
      Discover a seamless blend of productivity tools and wellness features that empower you to work smarter, reduce stress, and find balance in your daily life.
    </h2>
